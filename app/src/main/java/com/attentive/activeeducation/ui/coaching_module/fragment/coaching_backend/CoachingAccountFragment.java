...
public class CollegeAccountFragment extends Fragment {
    private View view;
    private ArrayList<AccountModel> accountModels = new ArrayList<>();


    public static CollegeAccountFragment newInstance(Bundle b) {
        CollegeAccountFragment fragment = new CollegeAccountFragment();
