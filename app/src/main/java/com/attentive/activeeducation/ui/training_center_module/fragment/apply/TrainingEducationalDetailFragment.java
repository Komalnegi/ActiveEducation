...
public class CoachingEducationalDetailFragment extends Fragment {
    private View view;
    ...
    public static CoachingEducationalDetailFragment newInstance(Bundle b) {
        CoachingEducationalDetailFragment fragment = new CoachingEducationalDetailFragment();
