...
public class CachingProfileFragment extends Fragment implements View.OnClickListener,
    ...
    public static CachingProfileFragment newInstance(Bundle b) {
        CachingProfileFragment fragment = new CachingProfileFragment();
