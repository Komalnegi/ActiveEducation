...
public class CollegePersonalDetailFragment extends Fragment implements View.OnClickListener{
    private View view;
    ...
    public static CollegePersonalDetailFragment newInstance(Bundle b) {
        CollegePersonalDetailFragment fragment = new CollegePersonalDetailFragment();
